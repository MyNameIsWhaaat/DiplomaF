    ...
    return (
        ...
        <div className="flex w-full h-screen">
            ...
            <aside className="w-1/4 min-w-[240px] bg-gradient-to-b from-[#8278F6] to-[#C7C4E9] text-white p-6 flex flex-col items-center shadow-lg rounded-tr-2xl rounded-br-2xl">
                <h2 className="text-2xl font-bold mb-4 MontserratBold tracking-wide">Мои курсы</h2>
                ...
                <div className="w-full flex flex-col gap-2 mb-6">
                    {courses.map((course) => (
                        <button
                            ...
                            className={`w-full py-2 px-4 rounded-lg text-2xl font-semibold text-center MontserratBold transition-all duration-200
          ${course.id === selectedCourseId
                ...
                <div className="w-full mt-auto">
                    <button
                        ...
                        className="w-full bg-white text-[#8278F6] text-2xl font-bold py-2 rounded-lg hover:bg-[#f3f2ff] transition border border-white/40 shadow-sm"
                    >
                        Главная страница
                    </button>
                </div>
